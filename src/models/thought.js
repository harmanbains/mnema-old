...
thoughtSchema.methods.toJSON = function () {
  ...
  console.log(thoughtObject.createdAt.toLocaleString({timeZone: 'America/Los_Angeles'}))
  console.log(thoughtObject.createdAt.toLocaleString({timeZone: 'America/New_York'}))
